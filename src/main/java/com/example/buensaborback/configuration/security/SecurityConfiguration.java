        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                //EMPLEADO
                                .requestMatchers(HttpMethod.GET, "/empleado/getPorSucursal/{id}").hasAnyAuthority("SUPERADMIN","ADMIN","CAJERO","COCINERO","DELIVERY")
                                ...
                                .requestMatchers(HttpMethod.POST, "/empleado/getPorMail").permitAll()
                                ...
                                //PEDIDO
                                .requestMatchers(HttpMethod.GET, "/pedido/ingresos/{idSucursal}").hasAnyAuthority("SUPERADMIN","ADMIN","COCINERO","DELIVERY","CAJERO")
                                .requestMatchers(HttpMethod.GET, "/pedido/cantidad-pedidos-por-cliente/{idSucursal}").hasAnyAuthority("SUPERADMIN","ADMIN","COCINERO","DELIVERY","CAJERO")
                                .requestMatchers(HttpMethod.GET, "/pedido/ganancia/{idSucursal}").hasAnyAuthority("SUPERADMIN","ADMIN","COCINERO","DELIVERY","CAJERO")
                                .requestMatchers(HttpMethod.GET, "/pedido/ranking-articulos/{idSucursal}").hasAnyAuthority("SUPERADMIN","ADMIN","COCINERO","DELIVERY","CAJERO")
                                .requestMatchers(HttpMethod.GET, "/pedido/ranking-promociones/{idSucursal}").hasAnyAuthority("SUPERADMIN","ADMIN","COCINERO","DELIVERY","CAJERO")
                                .requestMatchers(HttpMethod.GET, "/pedido/getPorFecha/{idSucursal}").authenticated()
                                ...
                                .requestMatchers(HttpMethod.GET, "/pedido/getPorFechaYClienteYEstado/{idSucursal}/{idCliente}").authenticated()
                                ...
                                .requestMatchers(HttpMethod.PUT, "/pedido/{id}").hasAnyAuthority("SUPERADMIN","ADMIN","CAJERO","COCINERO")
                                ...
                                .requestMatchers(HttpMethod.PUT, "/pedido/pendiente/{id}").authenticated()
                                ...
                                .requestMatchers(HttpMethod.GET, "/sucursal/getInsumos/{idSucursal}").permitAll()
                                .requestMatchers(HttpMethod.GET, "/sucursal/getCategorias/{idSucursal}").permitAll()
                                .requestMatchers(HttpMethod.GET, "/sucursal/getPromociones/{idSucursal}").permitAll()

...
public class ArticuloInsumoMapperImpl implements ArticuloInsumoMapper {
    ...
    public ArticuloInsumoDto toDTO(ArticuloInsumo source) {
        ...
        if ( source.isEliminado() != null ) {
            articuloInsumoDto.setEliminado( source.isEliminado() );
        }
        articuloInsumoDto.setDenominacion( source.getDenominacion() );
        articuloInsumoDto.setPrecioVenta( source.getPrecioVenta() );
        articuloInsumoDto.setUnidadMedida( unidadMedidaToUnidadMedidaDto( source.getUnidadMedida() ) );
        articuloInsumoDto.setCategoria( categoriaToCategoriaDto( source.getCategoria() ) );
        ...
        articuloInsumoDto.setStockMaximo( source.getStockMaximo() );
        articuloInsumoDto.setEsParaElaborar( source.getEsParaElaborar() );
        articuloInsumoDto.setImagenes( imagenArticuloSetToImagenArticuloDtoList( source.getImagenes() ) );
    ...
    public ArticuloInsumo toEntity(ArticuloInsumoDto source) {
        ...
        articuloInsumo.eliminado( source.isEliminado() );
        articuloInsumo.denominacion( source.getDenominacion() );
        articuloInsumo.precioVenta( source.getPrecioVenta() );
        articuloInsumo.imagenes( imagenArticuloDtoListToImagenArticuloSet( source.getImagenes() ) );
    ...
    @Override
    public ArticuloInsumo toUpdate(ArticuloInsumo entity, ArticuloInsumoEditDto source) {
        if ( source == null ) {
            return entity;
        }
        ...
        entity.setPrecioCompra( source.getPrecioCompra() );
        entity.setStockActual( source.getStockActual() );
        entity.setStockMinimo( source.getStockMinimo() );
        entity.setStockMaximo( source.getStockMaximo() );
        entity.setEsParaElaborar( source.getEsParaElaborar() );
    ...
    @Override
    public ArticuloInsumo toEntityCreate(ArticuloInsumoCreateDto source) {
        if ( source == null ) {
            return null;
        }
        ...
        articuloInsumo.categoria( categoriaService.getById( source.getIdCategoria() ) );
        articuloInsumo.id( source.getId() );
        articuloInsumo.eliminado( source.isEliminado() );
        articuloInsumo.denominacion( source.getDenominacion() );
        articuloInsumo.precioVenta( source.getPrecioVenta() );
        articuloInsumo.imagenes( imagenArticuloDtoListToImagenArticuloSet( source.getImagenes() ) );
        articuloInsumo.unidadMedida( unidadMedidaCreateDtoToUnidadMedida1( source.getUnidadMedida() ) );
        articuloInsumo.precioCompra( source.getPrecioCompra() );
        articuloInsumo.stockActual( source.getStockActual() );
        articuloInsumo.stockMinimo( source.getStockMinimo() );
        articuloInsumo.stockMaximo( source.getStockMaximo() );
    ...
    @Override
    public ArticuloInsumo toUpdate(ArticuloInsumoEditDto source) {
        if ( source == null ) {
            return null;
        }

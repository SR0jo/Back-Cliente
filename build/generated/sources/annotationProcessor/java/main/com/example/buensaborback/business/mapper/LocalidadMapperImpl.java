...
public class LocalidadMapperImpl implements LocalidadMapper {
    ...
    @Override
    public Localidad toUpdate(Localidad entity, LocalidadCreateDto source) {
        if ( source == null ) {
            return entity;
        }
    ...
    @Override
    public Localidad toEntityCreate(LocalidadCreateDto source) {
        if ( source == null ) {
            return null;
        }
        ...
        localidad.provincia( provinciaService.getById( source.getIdProvincia() ) );
        localidad.nombre( source.getNombre() );

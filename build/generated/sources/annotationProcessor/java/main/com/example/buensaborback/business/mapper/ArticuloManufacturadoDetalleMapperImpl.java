...
public class ArticuloManufacturadoDetalleMapperImpl implements ArticuloManufacturadoDetalleMapper {
    ...
    @Override
    public ArticuloManufacturadoDetalle toEntityCreate(ArticuloManufacturadoDetalleCreateDto source) {
        if ( source == null ) {
            return null;
        }
        ...
        articuloManufacturadoDetalle.cantidad( source.getCantidad() );
        articuloManufacturadoDetalle.articuloInsumo( articuloInsumoCreateDtoToArticuloInsumo( source.getArticuloInsumo() ) );

        return articuloManufacturadoDetalle.build();
    }

    @Override
    public ArticuloManufacturadoDetalle toUpdate(ArticuloManufacturadoDetalle entity, ArticuloManufacturadoDetalleEditDto source) {
        if ( source == null ) {
            return entity;
        }
    ...
    protected UnidadMedida unidadMedidaCreateDtoToUnidadMedida(UnidadMedidaCreateDto unidadMedidaCreateDto) {
    ...
    protected ArticuloInsumo articuloInsumoCreateDtoToArticuloInsumo(ArticuloInsumoCreateDto articuloInsumoCreateDto) {
        ...
        articuloInsumo.unidadMedida( unidadMedidaCreateDtoToUnidadMedida( articuloInsumoCreateDto.getUnidadMedida() ) );
